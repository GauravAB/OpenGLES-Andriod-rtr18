package com.gabandroid.ThreeDimensionalTexturemap;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener,OnDoubleTapListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		//position buffer-----------------------------------------------------------------------------
		GLES31.glGenBuffers(1,vbo_pyramid_pos,0);
		GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER,vbo_pyramid_pos[0]);
		...
		GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER,pyramidVertices.length*4,verticesBufferPyramid,GLES31.GL_STATIC_DRAW);
		...
		byteBuffer.order(ByteOrder.nativeOrder());
		FloatBuffer textureBufferPyramid = byteBuffer.asFloatBuffer();
		textureBufferPyramid.put(pyramidTexcoords);
		textureBufferPyramid.position(0);

		GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER,pyramidTexcoords.length*4,textureBufferPyramid,GLES31.GL_STATIC_DRAW);
		...
		GLES31.glGenBuffers(1,vbo_cube_pos,0);
		GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER,vbo_cube_pos[0]);
		...
		GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER,cubeVertices.length*4,verticesBufferCube,GLES31.GL_STATIC_DRAW);
		GLES31.glVertexAttribPointer(GLESMacros.GAB_ATTRIBUTE_VERTEX,3,GLES31.GL_FLOAT,false,0,0);
		GLES31.glEnableVertexAttribArray(GLESMacros.GAB_ATTRIBUTE_VERTEX);
		GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER,0);
		...
		byteBuffer = ByteBuffer.allocateDirect(cubeTextures.length*4);
		byteBuffer.order(ByteOrder.nativeOrder());
		FloatBuffer textureBufferCube = byteBuffer.asFloatBuffer();
		textureBufferCube.put(cubeTextures);
		textureBufferCube.position(0);

		GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER,cubeTextures.length*4,textureBufferCube,GLES31.GL_STATIC_DRAW);
		GLES31.glVertexAttribPointer(GLESMacros.GAB_ATTRIBUTE_TEXTURE0,2,GLES31.GL_FLOAT,false,0,0);
		GLES31.glEnableVertexAttribArray(GLESMacros.GAB_ATTRIBUTE_TEXTURE0);
		GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER,0);
	...
	private void uninitialize()
	{
		...
		{
			GLES31.glDeleteBuffers(1,vbo_pyramid_pos,0);
			vbo_pyramid_pos[0] = 0;
		}
		...
		if(vbo_cube_pos[0] != 0)
		{
			GLES31.glDeleteBuffers(1,vbo_cube_pos,0);
			vbo_cube_pos[0] = 0;
		}
