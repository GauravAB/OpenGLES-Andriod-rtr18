package com.gabandroid.TweakSmiley;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener,OnDoubleTapListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		//data inside buffer
		textureBufferSquare.put(0);
		//start from
		textureBufferSquare.position(0);
			
		GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER,32,textureBufferSquare,GLES31.GL_DYNAMIC_DRAW);
		...
		System.out.println("GAB: initialize complete\n");
	...
	private void display()
	{
		...
		switch(count[0])
		{
			case 0:
					...
					byteBuffer.order(ByteOrder.nativeOrder());
					FloatBuffer textureBufferSquare = byteBuffer.asFloatBuffer();
					textureBufferSquare.put(squareTexCoords);
					textureBufferSquare.position(0);
				
					GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER,squareTexCoords.length*4,textureBufferSquare,GLES31.GL_DYNAMIC_DRAW);
					GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER,0);
				break;
			case 1:
					...
					byteBuffer.order(ByteOrder.nativeOrder());
					textureBufferSquare = byteBuffer.asFloatBuffer();
					textureBufferSquare.put(squareTexCoords);
					textureBufferSquare.position(0);
					GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER,squareTexCoords.length*4,textureBufferSquare,GLES31.GL_DYNAMIC_DRAW);
					GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER,0);
