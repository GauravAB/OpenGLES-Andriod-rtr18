package com.gabandroid.assignment8;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener,OnDoubleTapListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		GLES31.glGenBuffers(1,vbo_pos,0);
		GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER,vbo_pos[0]);
		...
		GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER,triangleColors.length*4,colorsBuffer,GLES31.GL_STATIC_DRAW);
	...
	private void uninitialize()
	{
		...
		if(vbo_pos[0] != 0)
		{
			GLES31.glDeleteBuffers(1,vbo_pos,0);
			vbo_pos[0] = 0;
		}
