...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener,OnDoubleTapListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER,pyramidColors.length*4,colorBufferPyramid,GLES31.GL_STATIC_DRAW);
		...
		GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER,cubeColors.length*4,colorBufferCube,GLES31.GL_STATIC_DRAW);
		GLES31.glVertexAttribPointer(GLESMacros.GAB_ATTRIBUTE_COLOR,3,GLES31.GL_FLOAT,false,0,0);
		GLES31.glEnableVertexAttribArray(GLESMacros.GAB_ATTRIBUTE_COLOR);
		GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER,0);
